...
const CATEGORY = () => {
  ...
  <div className="SHE container mb-3">
  <div className="flexWeKeda p-5"> <h2 className="text-start" id='CategoriesName'>Categories</h2>
  <button className="btn btn-light  py-2" id='All'>View All Categories</button>
  </div>
  </div>
    <div className="row g-3 mt-3 ">
      {/* Item 1 */}
      <div className="col-6 col-sm-6 col-md-6 col-lg-2 text-center" id='WEQ'>
